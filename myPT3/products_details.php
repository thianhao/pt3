...
<head>
  ...
  <title>Macintosh App Ordering System : Products Details</title>
  <!-- Bootstrap -->
...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_products_a170997_pt3 WHERE fld_product_num = :pid");
...
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-12 col-sm-5 col-sm-offset-1 col-md-4 col-md-offset-2 well well-sm text-center">
      ...
      <img src="products/<?php echo $readrow['fld_product_img'] ?>" class="img-responsive" style="display:inline; width:500px">
      <?php } ?>
    </div>
